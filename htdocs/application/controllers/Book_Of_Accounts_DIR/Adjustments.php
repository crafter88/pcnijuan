...
class Adjustments extends MY_Controller{
	...
	public function get_adjustments(){
		$this->load->view($this->layout, ['head_css'=>'fragments/head_css/bookofaccounts/adjustments', 'top_navbar'=>'fragments/top_navbar/global_top_navbar', 'content'=>'fragments/content/bookofaccounts/adjustments', 'footer_js'=>'fragments/footer_js/bookofaccounts/adjustments', 'back_button'=>'../book_of_accounts', 'active_nav'=>'bookofaccounts', 'user'=>$this->session->userdata('user')]);
	}
