...
<script>
	...
	$('#coa-lvl1').on('click', 'button.edit', function(){
		$('body').on('hidden.bs.popover', function (e) {
            $(e.target).data("bs.popover").inState = { click: false, hover: false, focus: false }
        });
	...
	$('#coa-lvl1').on('click', 'button.delete', function(){
        var data = lvl1.row(this.closest('tr')).data();
	...
	$('#coa-lvl2').on('click', 'button.edit', function(){
		$('body').on('hidden.bs.popover', function (e) {
            $(e.target).data("bs.popover").inState = { click: false, hover: false, focus: false }
        });
	...
	$('#coa-lvl2').on('click', 'button.delete', function(){
		var data = lvl2.row(this.closest('tr')).data();
	...
	$('#coa-lvl3').on('click', 'button.edit', function(){
		$('body').on('hidden.bs.popover', function (e) {
            $(e.target).data("bs.popover").inState = { click: false, hover: false, focus: false }
        });
	...
	$('#coa-lvl3').on('click', 'button.delete', function(){
		var data = lvl3.row(this.closest('tr')).data();
	...
	$('#coa-lvl4').on('click', 'button.edit', function(){
		$('body').on('hidden.bs.popover', function (e) {
            $(e.target).data("bs.popover").inState = { click: false, hover: false, focus: false }
        });
	...
	$('#coa-lvl4').on('click', 'button.delete', function(){
		var data = lvl4.row(this.closest('tr')).data();
	...
	$('#coa-lvl5').on('click', 'button.edit', function(){
		$('body').on('hidden.bs.popover', function (e) {
            $(e.target).data("bs.popover").inState = { click: false, hover: false, focus: false }
        });
	...
	$('#coa-lvl5').on('click', 'button.delete', function(){
		var data = lvl5.row(this.closest('tr')).data();
