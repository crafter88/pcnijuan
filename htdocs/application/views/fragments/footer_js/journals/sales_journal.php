...
<script src="<?php echo base_url(); ?>/assets/js/apps/journals/parts/summary_sales.js"></script>
<script src="<?php echo base_url(); ?>/assets/js/apps/journals/parts/business_partners_sales.js"></script>
<script src="<?php echo base_url(); ?>/assets/js/apps/journals/restriction.js"></script>
<script>
