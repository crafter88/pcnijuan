...
<script src="<?php echo base_url(); ?>/assets/js/apps/journals/parts/summary_receipts.js"></script>
<script src="<?php echo base_url(); ?>/assets/js/apps/journals/parts/business_partners_receipts.js"></script>
<script>
