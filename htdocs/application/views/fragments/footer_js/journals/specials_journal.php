...
<script src="<?php echo base_url(); ?>/assets/js/apps/journals/parts/summary_specials.js"></script>
<script src="<?php echo base_url(); ?>/assets/js/apps/journals/parts/business_partners_specials.js"></script>
<script>
