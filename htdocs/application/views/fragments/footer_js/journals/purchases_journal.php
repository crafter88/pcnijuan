...
<script src="<?php echo base_url(); ?>/assets/js/apps/journals/parts/summary_purchases.js"></script>
<script src="<?php echo base_url(); ?>/assets/js/apps/journals/parts/business_partners_purchases.js"></script>
<script>
