...
<script src="<?php echo base_url(); ?>/assets/js/apps/journals/parts/summary_collections.js"></script>
<script src="<?php echo base_url(); ?>/assets/js/apps/journals/parts/business_partners_collections.js"></script>
<script>
...
<script>
	$(document).ready(function(){
		$('button[payment_type=Cash]').trigger('click');
	});
</script>
<script>
