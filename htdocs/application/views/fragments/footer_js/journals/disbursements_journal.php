...
<script src="<?php echo base_url(); ?>/assets/js/apps/journals/parts/summary_disbursements.js"></script>
<script src="<?php echo base_url(); ?>/assets/js/apps/journals/parts/business_partners_disbursements.js"></script>
