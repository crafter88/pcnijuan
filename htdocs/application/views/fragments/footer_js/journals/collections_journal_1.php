...
<script>
	var summary_table = $('#collections-journal-summary-table').DataTable({
							ajax: window.location.origin+'/journals/collections/journals_summary/get',
							columns: [
										{'data': 'co_trans_id'},
										{
	...
	var bp_summary_table = $('#collections-bp-table').DataTable({
								ajax: window.location.origin+'/journals/collections/bp/get',
								columns: [
											{'data': 'bpc_class'},
											{'data': 'co_bp_code'},
											{'data': 'bp_name'},
	...
	var bp_transaction_details_table = $('#collections-transaction-details-table').DataTable({
							ajax: window.location.origin+'/journals/collections/bp_transaction/get?bp_id=0',
							columns: [
										{'data': 'co_trans_id'},
										{
											mData: function(rowData, settings, fullData){
...
<script>
	$('#collections-journal-summary-table_wrapper tbody').on('click', 'tr', function(){
		...
		summary_doc.find('input[name=transaction_id]').val(row_data.co_trans_id);
		summary_doc.find('input[name=transaction_date]').val(new Date(row_data.co_trans_date).toString('MMM d, yyyy'));
		summary_doc.find('input[name=journal_trans_id]').val(row_data.co_journ_trans_id);
		summary_doc.find('input[name=company_name]').val(row_data.cb_name);
		summary_doc.find('input[name=document_name]').val(row_data.co_trans_doc_name);
		summary_doc.find('input[name=company_address]').val(row_data.cb_address);
		summary_doc.find('input[name=document_number]').val(row_data.co_trans_doc_no);
		summary_doc.find('input[name=company_tin]').val(row_data.cb_tin);
		summary_doc.find('input[name=document_date]').val(new Date(row_data.co_trans_doc_date).toString('MMM d, yyyy'));
		summary_doc.find('input[name=bp_name]').val(row_data.bp_name);
		summary_doc.find('input[name=payment_type]').val(row_data.co_trans_doc_pay_type);
		summary_doc.find('input[name=bp_address]').val(row_data.co_bp_address);
		summary_doc.find('input[name=terms]').val(row_data.co_trans_doc_pay_terms);
		summary_doc.find('input[name=tin]').val(row_data.co_bp_tin);
		summary_doc.find('input[name=due_date]').val(new Date(row_data.co_trans_doc_pay_duedate).toString('MMMM d, yyyy'));
		summary_doc.find('input[name=bp_type]').val(row_data.bpt_type);
		summary_doc.find('input[name=particulars]').val(row_data.co_bp_particulars);
		summary_doc.find('input[name=payment_mode]').val(row_data.co_mop_name);
		summary_doc.find('input[name=payment_amount]').val(row_data.co_trans_doc_pay_amountpaid);
		summary_doc.find('input[name=check_number]').val(row_data.co_trans_doc_pay_checknumber);
		summary_doc.find('input[name=check_date]').val(new Date(row_data.co_trans_date).toString('MMM d, yyyy'));
		summary_doc.find('input[name=check_payee]').val(row_data.cb_name);
		summary_doc.find('input[name=bank]').val(row_data.b_name);
		summary_doc.find('input[name=account_number]').val(row_data.co_b_no);
	...
	$('#collections-bp-table_wrapper tbody').on('click', 'tr', function(){
		var row_data = bp_summary_table.row(this).data();
		bp_transaction_details_table.ajax.url(window.location.origin+'/journals/collections/bp_transaction/get?bp_id='+row_data.co_bp_id).load();
		$(this).closest('table').find('tr').css('background-color', '#FFF');
		$(this).closest('table').find('tr').css('color', 'rgba(0,0,0,.87)');
		$(this).css('background-color', 'rgb(133, 150, 214)');
		$(this).css('color', '#FFF');
	...
	$('#collections-transaction-details-table_wrapper tbody').on('click', 'tr', function(){
