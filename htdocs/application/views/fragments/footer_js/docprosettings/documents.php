<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/docpro_settings/table/documents.js"></script>
<script>
    $(document).ready(function(){
        ...
        var table = $('#documents-table').DataTable({
            ajax: window_location+'/docpro_settings/documents/get',
            columns:[
                        {
        ...
        $('#add').click(function(){
            ...
            $(this).popover({
                ...
                callback: function(){
                    ...
                    $.get(window_location+'/docpro_settings/documents/get_journals', function(response){
