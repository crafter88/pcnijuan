<script>
    $(document).ready(function(){
        ...
        var table = $('#company-table').DataTable({
            ajax: window_location+'/docpro_setup/company/get',
            columns:[
                        {
                        ...
                        {'data': 'name'}, {'data': 'cb_address'}, {'data': 'cb_tin'}, {'data': 'cb_class'}, {'data': 'bpt_type'}, {'data': 'cb_tax_type'},{'data': 'cb_cno'}, {'data': 'cb_email'}
                    ],
