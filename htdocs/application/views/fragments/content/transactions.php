<div class="side-body padding-top" id='journal-navs' ng-app='transactions' ng-controller='transaction'>
		...
		<div class='col-md-12'>
			<div role="tabpanel">
				...
				<ul class="nav nav-tabs" role="tablist" style="display: none;">
					...
					<li role="presentation"><a class='text-black' href="#documents" aria-controls="documents" role="tab" data-toggle="tab">Document</a></li>
				</ul>
				<!-- Tab panes -->
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane active" id="summary">
						<div class='card'>
							<div class='card-body' style='padding-top: 10px;'>
								<table id='transactions-journal-summary-table' class='table table-hover table-bordered' cellspacing="0" style='min-width: 1500px;'>
									<thead>
					...
					<div role="tabpanel" class="tab-pane" id="business-partners">
						<div class='card'>
							<div class='card-body' style='padding-top: 10px;'>
								<table id='transactions-bp-table' class='table table-hover table-bordered table-striped table-responsive' cellspacing="0" width="1200px">
									<thead>
										<th>BP Class</th>
										<th>BP Code</th>
										<th>BP Name</th>
						...
						<div id='bp-transaction-details' class='card box box-primary collapsed-box' style='margin-top: 20px;'>
							<div class='card-header'>
								<div class='card-title'>
							...
							<div class='card-body box-body' style="padding-top: 10px;">
								<table id='transactions-transaction-details-table' class='table table-bordered table-hovered table-striped' style='min-width: 1400px;'>
									<thead>
										<th>General Trans ID</th>
										<th>Trans Date</th>
										<th>Journal</th>
						...
						<div id='bp-document-details' class='card box box-primary collapsed-box' style='margin-top: 20px;'>
							<div class='card-header'>
								<div class='card-title'>
									<div class='title box-title'>Document Details</div>
								</div>
						...
						<div id='bp-journal-entries' class='card box box-primary collapsed-box' style='margin-top: 20px;'>
							<div class='card-header'>
								<div class='card-title'>
									<div class='title box-title'>Journal Entries</div>
								</div>
						...
						<div id='bp-document' class='card box box-primary collapsed-box' style='margin-top: 20px;'>
							<div class='card-header'>
								<div class='card-title'>
									<div class='title box-title'>Document</div>
								</div>
							...
							<div class='card-body box-body' style="padding: 0;">
								<div class='row document_temp hide'>
									<div class='col-md-12'>
										<div class='card'>
											<div class='card-body'>
											</div>
										...
										<div class='card' style='padding-bottom: 10px;'>
											<div class='card-body' style='padding: 25px; padding-top: 20px; padding-bottom: 0;'>
												<div class='col-md-12' style='padding-left: 24% !important; background-color: #404040; color: #FFF; width: 100.38%; margin-left: -0.19%; border: none !important;'>
													<table class='docu_top' width='70%'>
														<tr>
															<td style='width: 100px;'><label style='margin: 0;'>Transaction ID:</label></td>
															<td style='width: 98px;'><input type='text' class='form-control' name='transaction_id' style='width: 50px; border: none; background-color: #404040; color: #FFF; text-decoration: underline;' readonly /></td>
															<td style='width: 120px;'><label style='margin: 0;'>Transaction Date:</label></td>
															<td style='width: 155px;'><input type='text' class='form-control' name='transaction_date' style='width: 150px; border: none; background-color: #404040; color: #FFF; text-decoration: underline;' readonly /></td>
															<td style='width: 150px;'><label style='margin: 0;'>Journal Transaction ID</label></td>
															<td><input type='text' class='form-control' name='journal_trans_id' style='width: 50px; border: none; background-color: #404040; color: #FFF; text-decoration: underline;' readonly /></td>
														</tr>
													</table>
												</div>
												...
												<div class='row' style='padding-left: 1%; padding-right: 1%;'>
													<table width='100%'>
														...
														<tr>
															...
															<td style='padding-left: 5px;'><input name='company_tin' class='form-control' type='text' style='border: none; background-color: #FFF' readonly /></td>
															<td>&nbsp;</td>
															<td style='padding-right: 5px;'><input name='document_date' type='text' style='border: none; background-color: #FFF; text-align: right;' readonly /></td>
															<td style='padding-left: 10px; background-color: #BBBBBB; color: #000;'><label>Document Date</label></td>
														</tr>
														<tr>
												...
												<div class='row' style='padding-left: 1%; padding-right: 1%; margin-top: -80px'>
													<table width='100%'>
														<tr>
									...
									<div class='col-md-12' style='margin-bottom: 0;'>
										<div class='card' style='padding-bottom: 10px;'>
											<div class='card-body' style='padding: 25px; padding-top: 20px; padding-bottom: 0;'>
												<div class='col-md-12' style='padding-left: 24% !important; background-color: #404040; color: #FFF; width: 100.38%; margin-left: -0.19%; border: none !important;'>
													<table class='docu_top' width='100%'>
														<tr>
															...
															<td style='width: 122px;'><input name='transaction_id' type='text' class='form-control' style='width: 50px; border: none; background-color: #404040; color: #FFF; text-decoration: underline;' readonly /></td>
															<td style='width: 120px;'><label style='margin: 0;'>Transaction Date:</label></td>
															<td style='width: 155px;'><input name='transaction_date' type='text' class='form-control' style='width: 150px; border: none; background-color: #404040; color: #FFF; text-decoration: underline;' readonly /></td>
															<td style='width: 150px;'><label style='margin: 0;'>Journal Transaction ID</label></td>
															<td><input name='journal_trans_id' type='text' class='form-control' style='width: 50px; border: none; background-color: #404040; color: #FFF; text-decoration: underline;' readonly /></td>
														</tr>
													</table>
												...
												<div class='row' style='padding-left: 1%; padding-right: 1%; width: 102.35%;'>
													<table width='100%'>
														<tr>
															<td style='text-align: right; padding-right: 10px; background-color: #BBBBBB; color: #000; width: 200px;'><label>Company</label></td>
															<td style='padding-left: 5px;'><input name='company_name' class='form-control' type='text' style='border: none; background-color: #FFF' readonly /></td>
					...
					<div role="tabpanel" class="tab-pane" id="new-transactions">
						<form action="<?php echo base_url(); ?>transactions/save_trans" method='post'>
							<div class='card'>
									...
									<div class='col-md-12' style='margin-left: 12%;'>
										...
										<div class='col-md-4' style='width: 27%'>
											<div class='form-group disabled-form-group'>
												...
												<input name='journal_transaction_id' value='{{selected_journal.journal.journal_id}}' type='text' id='input-transaction-date' class='form-control' name='input-transaction-date' style='color: #000C98; text-align: center;' readonly />
											</div>
										</div>
									</div>
								</div>
								...
								<div class='card-body' id='card-2-form' style='padding: 0; padding-top: 15px; display: none;'>
									<div class='col-md-12 transaction-input-row-gutter'>
										...
										<div class='col-md-3 col-input-custom form-group label-floating has-primary trans-select'>
											...
											<ui-select id='journ_type' ng-model="selected_journal.journal" theme="selectize" class="form-control">
												<ui-select-match>{{$select.selected.journal_name}}</ui-select-match>
												<ui-select-choices repeat="journ in journal_array | filter: $select.search">
												  <div ng-bind-html="journ.journal_name | highlight: $select.search"></div>
												</ui-select-choices>
											</ui-select>
											<input name='doc_name' type="hidden" value='{{selected_journal.journal.journal_name}}' />
										</div>
									...
									<div class='col-md-12 transaction-input-row-gutter' style='margin-top: 10px;'>
										...
										<div class='col-md-2 col-input-custom form-group label-floating has-primary trans-select'>
											...
											<ui-select ng-model="selected_mop.mop" theme="selectize" class="form-control">
												<ui-select-match>{{$select.selected.co_mop_name}}</ui-select-match>
												<ui-select-choices repeat="item in mode_of_payment | filter: $select.search">
												  <div ng-bind-html="item.co_mop_name | highlight: $select.search"></div>
												</ui-select-choices>
											</ui-select>
							...
							<div class='card box box-primary collapsed-box' style='margin-top: 20px; background-color: #FFF;'>
														...
														<td>
															<div class='form-group no-margin trans-select'>
																<ui-select ng-model="bank.code" theme="selectize" class="form-control">
																	<ui-select-match>{{$select.selected.co_b_code}}</ui-select-match>
																	<ui-select-choices repeat="item in account_code | filter: $select.search">
																	  <div ng-bind-html="item.co_b_code | highlight: $select.search"></div>
																	</ui-select-choices>
																</ui-select>
							...
							<div class='card box box-primary collapsed-box' style='margin: 0 0 35px 0;'>
								<div class='card-header'>
									<div class='card-title'>
												...
												<tr>
													...
													<td style='vertical-align: top; width: 31.3%;'>
														<table width='100%'>
															...
															<tr>
																<td><input value="<?php echo $this->session->userdata('user')->p_fname.' '.$this->session->userdata('user')->p_mname.' '.$this->session->userdata('user')->p_lname; ?>" type='text' class='form-control' style='border: none; background-color: #FFF; text-align: right;' readonly></td>
																<td style='width: 50%; padding-left: 10px; background-color: #BBBBBB; color: #000;'><label>Prepared by</label></td>
															</tr>
															<tr>
																<td><input ng-model='transaction_date' type='text' class='form-control' style='border: none; background-color: #FFF; text-align: right;' readonly></td>
																<td style='width: 50%; padding-left: 10px; background-color: #BBBBBB; color: #000;'><label>Date</label></td>
															</tr>
															<tr>
									...
									<div class='card-body' style='padding: 25px; padding-top: 20px; padding-bottom: 0;'>
										<div class='col-md-12' style='padding-left: 24% !important; background-color: #404040; color: #FFF; width: 100.38%; margin-left: -0.19%;'>
											<table class='docu_top' width='100%'>
												<tr>
													<td style='width: 100px;'><label style='margin: 0;'>Transaction ID:</label></td>
													<td style='width: 98px;'><input value='23' type='text' id='input-transaction-id' class='form-control' name='input-transaction-id' style='width: 50px; border: none; background-color: #404040; color: #FFF; text-decoration: underline;' readonly /></td>
													<td style='width: 120px;'><label style='margin: 0;'>Transaction Date:</label></td>
										...
										<div class='row' style='padding-left: 1%; padding-right: 1%;'>
											<table width='100%'>
												<tr>
													<td style='text-align: right; padding-right: 10px; background-color: #BBBBBB; color: #000; width: 200px;'><label>Company</label></td>
													<td style='padding-left: 5px;'><input value="<?php echo $this->session->userdata('user')->name; ?>" class='form-control' type='text' style='border: none; background-color: #FFF' readonly /></td>
													<td>&nbsp;</td>
												...
												<tr>
													<td style='text-align: right; padding-right: 10px; background-color: #BBBBBB; color: #000;'><label>Company Address</label></td>
													<td style='padding-left: 5px;'><input value="<?php echo $this->session->userdata('user')->cb_address; ?>" class='form-control' type='text' style='border: none; background-color: #FFF' readonly /></td>
													<td>&nbsp;</td>
												...
												<tr>
													<td style='text-align: right; padding-right: 10px; background-color: #BBBBBB; color: #000;'><label>Company TIN</label></td>
													<td style='padding-left: 5px;'><input value="<?php echo $this->session->userdata('user')->cb_tin; ?>" class='form-control' type='text' style='border: none; background-color: #FFF' readonly /></td>
													<td>&nbsp;</td>
