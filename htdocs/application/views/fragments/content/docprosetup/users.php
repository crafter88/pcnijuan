...
<div id='add-popover' class='modal fade' role='dialog' tabindex='-1'>
	...
	<div class='col-md-8'>
		<form action="<?php echo base_url(); ?>docpro_setup/users/add" method='post' class='body'>
			<div class='modal-body'>
				<table style="width: 90%; margin-left: 20px;">
					<tr>
						...
						<td colspan='3' style='padding-top: 10px;'><input class='form-control v-required' type='text' name='add-fname'></td>
					</tr>
					<tr>
						<td style='padding-top: 10px; width: 150px; text-align: right; padding-right: 20px;'><label>Middle Name</label></td>
						<td colspan='3' style='padding-top: 10px;'><input class='form-control v-required' type='text' name='add-mname'></td>
					</tr>
					<tr>
						<td style='padding-top: 10px; width: 150px; text-align: right; padding-right: 20px;'><label>Last Name</label></td>
						<td colspan='3' style='padding-top: 10px;'><input class='form-control v-required' type='text' name='add-lname'></td>
					</tr>
					<tr>
						<td style='padding-top: 10px; width: 150px; text-align: right; padding-right: 20px;'><label>Address</label></td>
						<td colspan='3' style='padding-top: 10px;'><input class='form-control v-required' type='text' name='add-address'></td>
					</tr>
					<tr>
						<td style='padding-top: 10px; width: 150px; text-align: right; padding-right: 20px;'><label>Mobile Number</label></td>
						<td colspan='3' style='padding-top: 10px;'><input class='form-control v-number v-format' f='^[0-9]{11}$' title='Mobile number format: 09xxxxxxxxx' type='text' name='add-cno'></td>
					</tr>
					<tr>
						<td style='padding-top: 10px; width: 150px; text-align: right; padding-right: 20px;'><label>Email</label></td>
						<td colspan='3' style='padding-top: 10px;'><input class='form-control v-format' f='@{1}' title="Email address requires '@'" type='text' name='add-email'></td>
					</tr>
					<tr>
						<td style='padding-top: 10px; width: 150px; text-align: right; padding-right: 20px;'><label>Username</label></td>
						<td colspan='3' style='padding-top: 10px;'><input class='form-control v-required v-format v-unique' u='/docpro_settings/users/check_username' f="^\S{6,}$" title='Minimum of 6 characters and must be unique' o_title='Minimum of 6 characters and must be unique' type='text' name='add-username'></td>
					</tr>
					<tr>
						<td style='padding-top: 10px; width: 150px; text-align: right; padding-right: 20px;'><label>Password</label></td>
						<td colspan='3' style='padding-top: 10px;'><input class='form-control v-required' title="Please fill out this field" type='password' name='add-password'></td>
					</tr>
					<tr>
						<td style='padding-top: 10px; width: 150px; text-align: right; padding-right: 20px;'><label>Re-Type Password</label></td>
						<td colspan='3' style='padding-top: 10px;'><input class='form-control v-required' title="Please fill out this field" type='password' name='add-r-password'></td>
					</tr>
					<tr>
...
<div id='edit-popover' class='modal fade' role='dialog' tabindex='-1'>
	...
	<div class='col-md-8'>
		<form action="<?php echo base_url(); ?>docpro_setup/users/edit" method='post' class='body'>
			<div class='modal-body'>
