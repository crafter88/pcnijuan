<div role="tabpanel" class="tab-pane" id="new-transactions">
	<form action="<?php echo base_url(); ?>journals/save_disbursement_trans" method='post' novalidate>
			...
			<div class='card-body' id='card-2-form' style='padding: 0; padding-top: 15px;'>
				<div class='col-md-12 transaction-input-row-gutter'>
					...
					<div class='col-md-3 col-input-custom form-group label-floating has-primary'>
						...
						<input name='doc_number' id='doc_number' ng-model='document_number' class='form-control number v-required v-decimal' type='text' style='color: #000C98; text-align: center;' />
					</div>
					<div class='col-md-3 col-input-custom form-group label-floating has-primary'>
				...
				<div class='col-md-12 transaction-input-row-gutter' style='margin-top: 10px;'>
					...
					<div class='col-md-2 col-input-custom form-group label-floating has-primary'>
						...
						<input name='payment_check_number' ng-model='payment_check_number' type='text' class='form-control number v-decimal' style='color: #000C98; text-align: center;' />
					</div>
					<div class='col-md-2 col-input-custom form-group label-floating has-primary trans-select'>
...
<div id='prod-serv-modal' class='modal fade-scale' role='dialog' tabindex='-1'>
	<div class='modal-dialog'>
		<div class='modal-content'>
			...
			<form action='<?php echo base_url(); ?>journals/add_product_service' method='post' class='body'>
