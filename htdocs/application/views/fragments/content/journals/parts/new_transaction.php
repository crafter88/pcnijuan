<div role="tabpanel" class="tab-pane" id="new-transactions">
	<form action="<?php echo base_url(); ?>journals/save_sale_trans" method='post' novalidate>
		...
		<div id='transaction-document' class='card box' style='margin: 0; padding-bottom: 20px; margin-bottom: 3px !important;'>
			...
			<div class='card-body' id='card-2-form' style='padding: 0; padding-top: 20px;'>
				<div class='col-md-12 transaction-input-row-gutter' style="padding-left: 0;">
				...
				<div class='col-md-12 transaction-input-row-gutter' style='margin-top: 10px;'>
					...
					<div class='col-md-2 col-input-custom form-group label-floating has-primary'>
						...
						<input name='payment_check_number' ng-model='payment_check_number' type='text' class='form-control number v-number' style='color: #000C98; text-align: center;' />
					</div>
					<div class='col-md-2 col-input-custom form-group label-floating has-primary trans-select'>
				...
				<div class='col-md-12 transaction-input-row-gutter' style='margin-top: 10px;'>
					...
					<div class='col-md-2 col-input-custom form-group label-floating has-primary'>
						...
						<input name='amounts_gross_amount' ng-model='amounts_gross_amount' type='text' class='form-control decimal v-required v-decimal' style='color: #000C98; text-align: center;' />
					</div>
					<div class='col-md-2 col-input-custom form-group label-floating has-primary'>
						<label class='control-label'>VAT</label>
						<input name='amounts_vat' ng-model='amounts_vat' type='text' class='form-control decimal v-required v-decimal' style='color: #000C98; text-align: center;' />
					</div>
					<div class='col-md-2 col-input-custom form-group label-floating has-primary'>
						<label class='control-label'>TAX Withheld</label>
						<input name='amounts_tax_withheld' ng-model='amounts_tax_withheld' type='text' class='form-control decimal v-required v-decimal' style='color: #000C98; text-align: center;' />
					</div>
					<div class='col-md-2 col-input-custom form-group label-floating has-primary'>
						<label class='control-label'>Deductions</label>
						<input name='amounts_deductions' ng-model='amounts_deductions' type='text' class='form-control decimal v-required v-decimal' style='color: #000C98; text-align: center;' />
					</div>
					<div class='col-md-2 col-input-custom form-group label-floating has-primary disabled-form-group'>
