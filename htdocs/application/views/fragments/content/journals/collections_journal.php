							...
							<div class='col-md-12'>
								<div role="tabpanel">
									...
									<ul id="journals-tab" class="nav nav-tabs" role="tablist">
										...
										<li role="presentation"><a class='text-black' href="#documents" aria-controls="documents" role="tab" data-toggle="tab">Collections Receipts</a></li>
									...
									<div class="tab-content">
										...
										<div role="tabpanel" class="tab-pane active" id="summary">
											<div class='box'>
												...
												<div class='box-body' style='padding-top: 10px; padding-right: 25px; padding-left: 13px;'>
													<table id='journal-summary-table' class='table table-hover table-bordered' cellspacing="0" style='width: 100%;'>
														<thead>
											...
											<div id='summary-document-details-card' class='card box box-primary' style='margin: 0; margin-bottom: 3px !important;'>
												...
												<div class='card-body box-body' style="padding-top: 0;">
													<div class="box box-primary collapsed-box" style='margin-top: 10px; border-top: none; background-color: #F7F7F7; display: none;'>
										...
										<div role="tabpanel" class="tab-pane" id="business-partners">
											...
											<div id='bp-transaction-details' class='card box box-primary collapsed-box' style='margin: 0; margin-bottom: 3px !important;'>
												...
												<div class='box-body' style='padding-top: 10px; padding-right: 25px; padding-left: 13px;'>
													<table id='transaction-details-table' class='table table-bordered table-hovered table-striped' style='width: 100%;'>
														<thead>
															<th>General Trans ID</th>
															<th>Trans Date</th>
															<th>Journal</th>
