...
<div id='view-popover' class='modal fade' role='dialog' tabindex='-1'>
	...
	<div class='modal-body'>
		<table width='90%'>
			...
			<tr>
				<td style='padding-top: 5px; text-align: right; padding-right: 20px;'><label>Department</label></td>
			...
			<tr>
				<td style='padding-top: 5px; width: 119px; text-align: right; padding-right: 20px;'><label>Shortname</label></td>
	...
	<form action='<?php echo base_url(); ?>company_settings/profit_cost_centers/edit' method='post' class='body'>
		<div class='modal-body'>
			<table width='90%'>
				...
				<tr>
					<td style='padding-top: 5px; width: 150px; text-align: right; padding-right: 20px;'><label>Name</label></td>
					<td colspan='3' style='padding-top: 5px;'><input id='edit-name' class='form-control v-required' title='Please fill out this field' type='text' name='edit-name'></td>
				</tr>
				<tr>
					<td style='padding-top: 5px; width: 150px; text-align: right; padding-right: 20px;'><label>Shortname</label></td>
					<td colspan='3' style='padding-top: 5px;'><input id='edit-shortname' class='form-control' type='text' name='edit-shortname'></td>
				</tr>
			</table>
		</div>
	...
	<form action='<?php echo base_url(); ?>company_settings/profit_cost_centers/update' method='post' class='body'>
		<div class='modal-body'>
			<table width='90%'>
				...
				<tr>
					<td style='padding-top: 5px; width: 150px; text-align: right; padding-right: 20px;'><label>Name</label></td>
					<td colspan='3' style='padding-top: 5px;'><input id='edit-name' class='form-control v-required' title='Please fill out this field' type='text' name='update-name'></td>
				</tr>
				<tr>
					<td style='padding-top: 5px; width: 150px; text-align: right; padding-right: 20px;'><label>Shortname</label></td>
					<td colspan='3' style='padding-top: 5px;'><input id='edit-shortname' class='form-control' type='text' name='update-shortname'></td>
				</tr>
			</table>
		</div>
...
<div id='add-department-modal' class='modal fade-scale' tabindex="-1" role="dialog">
	<div class="modal-dialog">
		<div class='modal-content'>
			...
			<form action='<?php echo base_url(); ?>company_settings/profit_cost_centers/add_department' method='post'>
				<div class='modal-body'>
