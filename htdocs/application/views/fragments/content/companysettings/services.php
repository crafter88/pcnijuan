    		...
    		<div class='box-body hide-table-setting'>
    			<div class='row'>
    				<div class='col-md-12' id='company-table-row' style="padding-right: 20px;">
						...
						<table id='services-table' class='table table-hovered table-bordered' style="width: 100%;">
							<thead>
								<tr>
									<th></th>
									<th>Sequence</th>
...
<div id='add-popover' class='modal fade' role='dialog' tabindex='-1'>
	<div style='border-bottom: 1px groove; height: 30px; padding-bottom: 10px;'>
		...
		<h4 class='modal-title' style="font-family: 'Roboto Condensed', sans-serif;">Add Service</h4>
	</div>
	<form action='<?php echo base_url(); ?>company_settings/services/add' method='post' class='body'>
...
<div id='view-popover' class='modal fade' role='dialog' tabindex='-1'>
	<div style='border-bottom: 1px groove; height: 30px; padding-bottom: 10px;'>
		...
		<h4 class='modal-title' style="font-family: 'Roboto Condensed', sans-serif;">View Service</h4>
	</div>
	<div class='modal-body'>
		<table width='90%'>
			<tr>
...
<div id='edit-popover' class='modal fade' role='dialog' tabindex='-1'>
	<div style='border-bottom: 1px groove; height: 30px; padding-bottom: 10px;'>
		<button class='close close-popover' type='button' data-dismiss='modal' style='padding-right: 10px;'><span aria-hidden='true'>&times;</span></button>
		<h4 class='modal-title' style="font-family: 'Roboto Condensed', sans-serif;">Edit Service</h4>
	</div>
	<form action='<?php echo base_url(); ?>company_settings/services/edit' method='post' class='body'>
		<div class='modal-body'>
			<table width='90%'>
				<tr>
					<td style='padding-top: 5px; width: 150px; text-align: right; padding-right: 20px;'><label>Sequence</label></td>
...
<div id='update-popover' class='modal fade' role='dialog' tabindex='-1'>
	<div style='border-bottom: 1px groove; height: 30px; padding-bottom: 10px;'>
		<button class='close close-popover' type='button' data-dismiss='modal' style='padding-right: 10px;'><span aria-hidden='true'>&times;</span></button>
		<h4 class='modal-title' style="font-family: 'Roboto Condensed', sans-serif;">Update Service</h4>
	</div>
	<form action='<?php echo base_url(); ?>company_settings/services/update' method='post' class='body'>
		<div class='modal-body'>
			<table width='90%'>
				<tr>
					<td style='padding-top: 5px; width: 150px; text-align: right; padding-right: 20px;'><label>Sequence</label></td>
...
<div id='add-department-modal' class='modal fade-scale' tabindex="-1" role="dialog">
	<div class="modal-dialog">
		<div class='modal-content'>
			...
			<form action='<?php echo base_url(); ?>company_settings/services/add_department' method='post'>
				<div class='modal-body'>
...
<div id='add-pcc-modal' class='modal fade-scale' tabindex="-1" role="dialog">
	<div class="modal-dialog">
		<div class='modal-content'>
			...
			<form action='<?php echo base_url(); ?>company_settings/services/add_pcc' method='post' class='body'>
				<div class='modal-body'>
					<table width='90%'>
						<tr class='add-department'>
							<td style='padding-top: 5px; width: 150px; text-align: right; padding-right: 20px;'><label>Department</label></td>
