<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/css/company_settings/branch_seq.css">
<style>
	#branches-table_wrapper .row > [class*="col-"]{
	...
	#branches-table_wrapper .row:first-child{
		margin-bottom: 0;
	}
</style>
<style>
	...
	.edit-modal-body .modal-body, .edit-modal-body .col-md-4, .update-modal-body .modal-body, .update-modal-body .col-md-4{
		height: 275px;
	}
