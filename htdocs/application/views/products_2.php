...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" href="<?php echo base_url(); ?>libs/favicon.ico" type="image/x-icon">
    ...
    <link href="<?php echo base_url(); ?>libs/plugins/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css" rel="stylesheet" />

    <!-- Wait Me Css -->
    <link href="<?php echo base_url(); ?>libs/plugins/waitme/waitMe.css" rel="stylesheet" />

    <!-- Bootstrap Select Css -->
    <link href="<?php echo base_url(); ?>libs/plugins/bootstrap-select/css/bootstrap-select.css" rel="stylesheet" />

    <!-- Custom Css -->
    <link href="<?php echo base_url(); ?>libs/css/style.css" rel="stylesheet">

    <!-- AdminBSB Themes. You can choose a theme from css/themes instead of get all themes -->
    <link href="<?php echo base_url(); ?>libs/css/themes/all-themes.css" rel="stylesheet" />
</head>
...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url(); ?>libs/index.html">ADMINBSB - MATERIAL DESIGN</a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="<?php echo base_url(); ?>libs/images/user.png" width="48" height="48" alt="User" />
                </div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>libs/index.html">
                            <i class="material-icons">home</i>
                            <span>Home</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>libs/pages/typography.html">
                            <i class="material-icons">text_fields</i>
                            <span>Typography</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>libs/pages/helper-classes.html">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="<?php echo base_url(); ?>libs/pages/widgets/cards/basic.html">Basic</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>libs/pages/widgets/cards/colored.html">Colored</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>libs/pages/widgets/cards/no-header.html">No Header</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="<?php echo base_url(); ?>libs/pages/widgets/infobox/infobox-1.html">Infobox-1</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>libs/pages/widgets/infobox/infobox-2.html">Infobox-2</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>libs/pages/widgets/infobox/infobox-3.html">Infobox-3</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>libs/pages/widgets/infobox/infobox-4.html">Infobox-4</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>libs/pages/widgets/infobox/infobox-5.html">Infobox-5</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/ui/alerts.html">Alerts</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/ui/animations.html">Animations</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/ui/badges.html">Badges</a>
                            </li>

                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/ui/breadcrumbs.html">Breadcrumbs</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/ui/buttons.html">Buttons</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/ui/collapse.html">Collapse</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/ui/colors.html">Colors</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/ui/dialogs.html">Dialogs</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/ui/icons.html">Icons</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/ui/labels.html">Labels</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/ui/list-group.html">List Group</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/ui/media-object.html">Media Object</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/ui/modals.html">Modals</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/ui/notifications.html">Notifications</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/ui/pagination.html">Pagination</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/ui/preloaders.html">Preloaders</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/ui/progressbars.html">Progress Bars</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/ui/range-sliders.html">Range Sliders</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/ui/sortable-nestable.html">Sortable & Nestable</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/ui/tabs.html">Tabs</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/ui/thumbnails.html">Thumbnails</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/ui/tooltips-popovers.html">Tooltips & Popovers</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/ui/waves.html">Waves</a>
                            </li>
                        </ul>
                    </li>
                    <li class="active">
                        ...
                        <ul class="ml-menu">
                            <li class="active">
                                <a href="<?php echo base_url(); ?>libs/pages/forms/basic-form-elements.html">Basic Form Elements</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/forms/advanced-form-elements.html">Advanced Form Elements</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/forms/form-examples.html">Form Examples</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/forms/form-validation.html">Form Validation</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/forms/form-wizard.html">Form Wizard</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/forms/editors.html">Editors</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/tables/normal-tables.html">Normal Tables</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/tables/jquery-datatable.html">Jquery Datatables</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/tables/editable-table.html">Editable Tables</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/medias/image-gallery.html">Image Gallery</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/medias/carousel.html">Carousel</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/charts/morris.html">Morris</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/charts/flot.html">Flot</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/charts/chartjs.html">ChartJS</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/charts/sparkline.html">Sparkline</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/charts/jquery-knob.html">Jquery Knob</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/examples/sign-in.html">Sign In</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/examples/sign-up.html">Sign Up</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/examples/forgot-password.html">Forgot Password</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/examples/blank.html">Blank Page</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/examples/404.html">404 - Not Found</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/examples/500.html">500 - Server Error</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/maps/google.html">Google Map</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/maps/yandex.html">YandexMap</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>libs/pages/maps/jvectormap.html">jVectorMap</a>
                            </li>
                        </ul>
                    </li>
                    <li>
    ...
    <!-- Select Plugin Js -->
    <script src="<?php echo base_url(); ?>libs/plugins/bootstrap-select/js/bootstrap-select.js"></script>

    <!-- Slimscroll Plugin Js -->
    <script src="<?php echo base_url(); ?>libs/plugins/jquery-slimscroll/jquery.slimscroll.js"></script>

    <!-- Waves Effect Plugin Js -->
    <script src="<?php echo base_url(); ?>libs/plugins/node-waves/waves.js"></script>

    <!-- Autosize Plugin Js -->
    <script src="<?php echo base_url(); ?>libs/plugins/autosize/autosize.js"></script>

    <!-- Moment Plugin Js -->
    <script src="<?php echo base_url(); ?>libs/plugins/momentjs/moment.js"></script>

    <!-- Bootstrap Material Datetime Picker Plugin Js -->
    <script src="<?php echo base_url(); ?>libs/plugins/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js"></script>

    <!-- Custom Js -->
    <script src="<?php echo base_url(); ?>libs/js/admin.js"></script>
    <script src=".<?php echo base_url(); ?>libs/js/pages/forms/basic-form-elements.js"></script>

    <!-- Demo Js -->
    <script src="<?php echo base_url(); ?>libs/js/demo.js"></script>
</body>
</html>