...
var tax_types = $('#tax-types').DataTable({
	...
	order: [['1', 'asc']],
	columnDefs: [{targets: 0, width: '40px'},{targets: [0,1], width: '40px'}],
	sDom: '<"top"f>rt<"bottom"p><"clear">',
	scrollX: true,
	bSort: false,
});
...
var tax = $('#tax').DataTable({
	...
	order: [['1', 'asc']],
	columnDefs: [{targets: 0, width: '40px'}, {targets: 3, width: '70px'},{targets: [1,2], width: '40px'},{targets: 5, width: '150px'},{targets: [6,7], width: '80px'}],
	sDom: '<"top"f>rt<"bottom"p><"clear">',
	scrollX: true,
	bSort: false,
	initComplete: function(){
