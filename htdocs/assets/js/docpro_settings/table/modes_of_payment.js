...
var init_filter = function(table){
    ...
    filter1 = $('#filter1').selectize({
        ...
        onChange: function(value){
            ...
            table.ajax.url(window_location+'/docpro_settings/modes_of_payment/filter_table?filter1='+val1).load();
        }
    });

    var init_filter1 = function(){
        $.get(window_location+'/docpro_settings/modes_of_payment/get_filter1', function(response){
