		...
		.directive('addProductServicesBtnFunction', function($compile){
			return{
				...
				controller: function($scope, $http){
					...
					$http.get(window_location+'/journals/collections/transaction/product_service/get').then(function success(response){
		...
		.directive('addDiscountsBtnFunction', function($compile){
			return{
				...
				controller: function($scope, $http){
					...
					$http.get(window_location+'/journals/collections/transaction/discount/get').then(function success(response){
						$.each(response.data, function(index, data){
		...
		.directive('addDocumentReferenceBtnFunction', function($compile){
			return{
				...
				controller: function($scope, $http){
					...
					$http.get(window_location+'/journals/collections/transaction/doc_ref/get').then(function success(response){
						$.each(response.data, function(index, data){
		...
		.directive('addJournalEntryBtnFunction', function($compile){
			return{
				...
				controller: function($scope, $http){
					...
					$http.get(window_location+'/journals/collections/transaction/je_account/get').then(function success(response){
						$.each(response.data, function(index, data){
					...
					$http.get(window_location+'/journals/collections/transaction/je_pcc/get').then(function success(response){
						$.each(response.data, function(index, data){
					...
					$http.get(window_location+'/journals/collections/transaction/je_dept/get').then(function success(response){
						$.each(response.data, function(index, data){
			...
			return{
				...
				template: function(){
					return "<button payment_type='Cash' ng-click='set_type_of_payment($event)' class='btn cash-credit' type='button' style='margin-right: 5px; border: 1px solid #CCC; margin-top: 10px; padding: 8px 20px;'>Cash</button>"+
							"<button payment_type='Credit' ng-click='set_type_of_payment($event)' class='btn cash-credit' type='button' style='border: 1px solid #CCC; margin-top: 10px; padding: 8px 20px; display: none;'>Charge</button>";
				}
			}
		})