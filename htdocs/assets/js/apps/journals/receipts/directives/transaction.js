		...
		.directive('addProductServicesBtnFunction', function($compile){
			return{
				...
				controller: function($scope, $http){
					...
					$http.get(window_location+'/journals/receipts/transaction/product_service/get').then(function success(response){
		...
		.directive('addVatBtnFunction', function($compile){
			return{
				...
				controller: function($scope,$http){
					...
					$http.get(window_location+'/journals/receipts/transaction/vat/get', {params: {id: $scope.selected_bp_id}}).then(function success(response){
						$.each(response.data, function(index, data){
		...
		.directive('addDiscountsBtnFunction', function($compile){
			return{
				...
				controller: function($scope, $http){
					...
					$http.get(window_location+'/journals/receipts/transaction/discount/get').then(function success(response){
						$.each(response.data, function(index, data){
		...
		.directive('addExpandedTaxBtnFunction', ['$compile', function($compile){
			return{
				...
				controller: function($scope, $http){
					...
					$http.get(window_location+'/journals/receipts/transaction/ewt/get', {params: {id: $scope.selected_bp_id}}).then(function success(response){
						$.each(response.data, function(index, data){
		...
		.directive('addFinalWithholdingTaxBtnFunction', function($compile){
			return{
				...
				controller: function($scope, $http){
					...
					$http.get(window_location+'/journals/receipts/transaction/fwt/get', {params: {id: $scope.selected_bp_id}}).then(function success(response){
						$.each(response.data, function(index, data){
		...
		.directive('addDocumentReferenceBtnFunction', function($compile){
			return{
				...
				controller: function($scope, $http){
					...
					$http.get(window_location+'/journals/receipts/transaction/doc_ref/get').then(function success(response){
						$.each(response.data, function(index, data){
		...
		.directive('addBankDetailsBtnFunction', function($compile){
			return{
				...
				controller: function($scope, $http){
					...
					$http.get(window_location+'/journals/receipts/transaction/bank/get').then(function success(response){
						$.each(response.data, function(index, data){
		...
		.directive('addJournalEntryBtnFunction', function($compile){
			return{
				...
				controller: function($scope, $http){
					...
					$http.get(window_location+'/journals/receipts/transaction/je_account/get').then(function success(response){
						$.each(response.data, function(index, data){
					...
					$http.get(window_location+'/journals/receipts/transaction/je_pcc/get').then(function success(response){
						$.each(response.data, function(index, data){
					...
					$http.get(window_location+'/journals/receipts/transaction/je_dept/get').then(function success(response){
						$.each(response.data, function(index, data){
