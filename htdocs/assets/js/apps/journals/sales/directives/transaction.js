		...
		.directive('addDocumentReferenceBtnFunction', function($compile){
			return{
				...
				controller: function($scope, $http){
					...
					$http.get(window_location+'/journals/sales/transaction/doc_ref/get').then(function success(response){
						$.each(response.data, function(index, data){
		...
		.directive('addJournalEntryBtnFunction', function($compile){
			return{
				...
				controller: function($scope, $http){
					...
					$http.get(window_location+'/journals/sales/transaction/je_account/get').then(function success(response){
						$.each(response.data, function(index, data){
					...
					$http.get(window_location+'/journals/sales/transaction/je_pcc/get').then(function success(response){
						$.each(response.data, function(index, data){
					...
					$http.get(window_location+'/journals/sales/transaction/je_dept/get').then(function success(response){
						$.each(response.data, function(index, data){
