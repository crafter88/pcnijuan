		...
		.directive('addVatBtnFunction', function($compile){
			return{
				...
				controller: function($scope,$http){
					...
					$http.get(window_location+'/journals/sales/transaction/vat/get').then(function success(response){
						$.each(response.data, function(index, data){
		...
		.directive('addExpandedTaxBtnFunction', ['$compile', function($compile){
			return{
				...
				controller: function($scope, $http){
					...
					$http.get(window_location+'/journals/sales/transaction/ewt/get').then(function success(response){
						$.each(response.data, function(index, data){
		...
		.directive('addFinalWithholdingTaxBtnFunction', function($compile){
			return{
				...
				controller: function($scope, $http){
					...
					$http.get(window_location+'/journals/sales/transaction/fwt/get').then(function success(response){
						$.each(response.data, function(index, data){
