...
var init_filter = function(table){
    ...
    filter1 = $('#filter1').selectize({
        ...
        onChange: function(value){
            ...
            table.ajax.url(window_location+'/company_settings/products/filter_table?filter1='+val1+'&'+'filter2='+val2).load();
        }
    });
    ...
    var init_filter1 = function(){
        $.get(window_location+'/company_settings/products/get_filter1', function(response){
    ...
    var init_filter2 = function(){
        $.get(window_location+'/company_settings/products/get_filter2', function(response){
            var json_data = JSON.parse(response);
            var options = [];
