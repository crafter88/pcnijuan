...
var init_table_settings = function(table){
    ...
    $('body').on('click', '#show-all-col', function(){
        ...
        var column9 = table.column(9);
        column9.visible(!column9.visible());

        var column10 = table.column(10);
...
var init_filter = function(table){
    ...
    filter1 = $('#filter1').selectize({
        ...
        onChange: function(value){
            ...
            table.ajax.url(window_location+'/company_settings/business_partners/filter_table?filter1='+val1+'&'+'filter2='+val2).load();
        }
    });
    ...
    var init_filter1 = function(){
        $.get(window_location+'/company_settings/business_partners/get_filter1', function(response){
    ...
    var init_filter2 = function(){
        $.get(window_location+'/company_settings/business_partners/get_filter2', function(response){
            var json_data = JSON.parse(response);
            var options = [];
