...
var init_filter = function(table){
    ...
    filter1 = $('#filter1').selectize({
        ...
        onChange: function(value){
            ...
            table.ajax.url(window_location+'/company_settings/profit_cost_centers/filter_table?filter1='+val1).load();
        }
    });

    var init_filter1 = function(){
        $.get(window_location+'/company_settings/profit_cost_centers/get_filter1', function(response){
